						...
						<tbody>
							<tr style="MIN-HEIGHT: 4px" class="xdTableContentRow">
								<td vAlign="top" class="xdTableContentCell" style="BORDER-TOP: #d8d8d8 1pt solid">
									...
									<div> </div>
									<div>
										<table style="BORDER-BOTTOM-STYLE: none; BORDER-LEFT-STYLE: none; WIDTH: 649px; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; BORDER-TOP-STYLE: none; TABLE-LAYOUT: fixed; BORDER-RIGHT-STYLE: none" class="xdFormLayout xdTableStyleTwoCol">
											<colgroup>
											...
											<tbody vAlign="top">
												<tr class="xdTableOffsetRow">
													<td class="xdTableOffsetCellLabel" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 22px; PADDING-RIGHT: 5px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<h4>
															<span class="xdlabel">Activation Email</span>
														</h4>
													</td>
													<td class="xdTableOffsetCellComponent" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 5px; PADDING-RIGHT: 22px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<object hideFocus="1" style="WIDTH: 100%; HEIGHT: 22px" class="xdActiveX" classid="clsid:61e40d31-993d-4777-8fa0-19ca59b6d0bb" tabIndex="0" xd:disableEditing="no" xd:SharePointGroup="0" xd:SearchPeopleOnly="false" xd:AllowMultiple="true" xd:boundProp="xd:inline" xd:bindingProperty="Value" xd:bindingType="xmlNode" xd:server="https://realtimelandscape.sharepoint.com/sites/realtimefoundation" xd:CtrlId="CTRL11" xd:xctname="{{61e40d31-993d-4777-8fa0-19ca59b6d0bb}}" tabStop="true" contentEditable="false" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:ActivationEmail">
															<xsl:if test="function-available('xdImage:getImageUrl')">
																<xsl:attribute name="src"><xsl:value-of select="xdImage:getImageUrl(dfs:dataFields/d:SharePointListItem_RW/d:ActivationEmail)"/></xsl:attribute>
															</xsl:if>
														...
														<div>
															<h6 style="FONT-WEIGHT: normal">Add all people you would like to inform of this contract approval.</h6>
														</div>
													</td>
												</tr>
												<tr class="xdTableOffsetRow">
													<td class="xdTableOffsetCellLabel" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 22px; PADDING-RIGHT: 5px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<h4>
															<span class="xdlabel">Contract Start Date</span>
														</h4>
													</td>
													<td class="xdTableOffsetCellComponent" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 5px; PADDING-RIGHT: 22px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<div style="WIDTH: 100%" class="xdDTPicker" title="" noWrap="1" xd:CtrlId="CTRL12" xd:xctname="DTPicker"><span hideFocus="1" class="xdDTText xdBehavior_FormattingNoBUI" contentEditable="true" xd:xctname="DTPicker_DTText" tabIndex="0" xd:disableEditing="no" xd:innerCtrl="_DTText" xd:boundProp="xd:num" xd:datafmt="&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:ContractStartDate">
																<xsl:attribute name="xd:num">
																	<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:ContractStartDate"/>
																</xsl:attribute>
																<xsl:choose>
																	<xsl:when test="function-available('xdFormatting:formatString')">
																		<xsl:value-of select="xdFormatting:formatString(dfs:dataFields/d:SharePointListItem_RW/d:ContractStartDate,&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;)"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:ContractStartDate"/>
																	</xsl:otherwise>
												...
												<tr class="xdTableOffsetRow">
													<td class="xdTableOffsetCellLabel" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 22px; PADDING-RIGHT: 5px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<h4>
															<span class="xdlabel">Contract Expiration Date</span>
														</h4>
													</td>
													<td class="xdTableOffsetCellComponent" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 5px; PADDING-RIGHT: 22px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<div style="WIDTH: 100%" class="xdDTPicker" title="" noWrap="1" xd:CtrlId="CTRL13" xd:xctname="DTPicker"><span hideFocus="1" class="xdDTText xdBehavior_FormattingNoBUI" contentEditable="true" xd:xctname="DTPicker_DTText" tabIndex="0" xd:disableEditing="no" xd:innerCtrl="_DTText" xd:boundProp="xd:num" xd:datafmt="&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:ContractExpirationDate">
																<xsl:attribute name="xd:num">
																	<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:ContractExpirationDate"/>
																</xsl:attribute>
																<xsl:choose>
																	<xsl:when test="function-available('xdFormatting:formatString')">
																		<xsl:value-of select="xdFormatting:formatString(dfs:dataFields/d:SharePointListItem_RW/d:ContractExpirationDate,&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;)"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:ContractExpirationDate"/>
																	</xsl:otherwise>
												...
												<tr class="xdTableOffsetRow">
													<td class="xdTableOffsetCellLabel" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 22px; PADDING-RIGHT: 5px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<h4>
															<span class="xdlabel">Schedule Task</span>
														</h4>
													</td>
													<td class="xdTableOffsetCellComponent" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 5px; PADDING-RIGHT: 22px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<object hideFocus="1" style="WIDTH: 100%; HEIGHT: 22px" class="xdActiveX" classid="clsid:61e40d31-993d-4777-8fa0-19ca59b6d0bb" tabIndex="0" xd:disableEditing="no" xd:SharePointGroup="0" xd:SearchPeopleOnly="true" xd:AllowMultiple="false" xd:boundProp="xd:inline" xd:bindingProperty="Value" xd:bindingType="xmlNode" xd:server="https://realtimelandscape.sharepoint.com/sites/realtimefoundation" xd:CtrlId="CTRL14" xd:xctname="{{61e40d31-993d-4777-8fa0-19ca59b6d0bb}}" tabStop="true" contentEditable="false" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:ScheduleTask">
															<xsl:if test="function-available('xdImage:getImageUrl')">
																<xsl:attribute name="src"><xsl:value-of select="xdImage:getImageUrl(dfs:dataFields/d:SharePointListItem_RW/d:ScheduleTask)"/></xsl:attribute>
															</xsl:if>
															<param NAME="ButtonFont" VALUE="Verdana,10,0,400,0,0,0"/>
															<param NAME="ButtonText" VALUE=""/>
															<param NAME="DisplayNameXPath" VALUE="pc:DisplayName"/>
														...
														<div>
															<h6 style="FONT-WEIGHT: normal">Person assigned to schedule the visits for this Contract</h6>
														</div>
													</td>
												</tr>
												<tr class="xdTableOffsetRow">
													<td class="xdTableOffsetCellLabel" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 22px; PADDING-RIGHT: 5px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<h4>
															<span class="xdlabel">Initial Visit Start Date and Time</span>
														</h4>
													</td>
													<td class="xdTableOffsetCellComponent" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 5px; PADDING-RIGHT: 22px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<div style="WIDTH: 223px" class="xdDTPicker" title="" noWrap="1" xd:CtrlId="CTRL15" xd:xctname="DTPicker"><span hideFocus="1" class="xdDTText xdBehavior_FormattingNoBUI" contentEditable="true" xd:xctname="DTPicker_DTText" tabIndex="0" xd:disableEditing="no" xd:innerCtrl="_DTText" xd:boundProp="xd:num" xd:datafmt="&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime">
																<xsl:attribute name="xd:num">
																	<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime"/>
																</xsl:attribute>
																<xsl:choose>
																	<xsl:when test="function-available('xdFormatting:formatString')">
																		<xsl:value-of select="xdFormatting:formatString(dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime,&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;)"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime"/>
																	</xsl:otherwise>
														...
														</div><span hideFocus="1" class="xdTextBox xdBehavior_Formatting" title="" contentEditable="true" xd:CtrlId="CTRL16" xd:xctname="PlainText" tabIndex="0" xd:disableEditing="no" xd:boundProp="xd:num" xd:datafmt="&quot;datetime&quot;,&quot;dateFormat:none;&quot;" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime" style="WIDTH: 223px">
															<xsl:attribute name="xd:num">
																<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime"/>
															</xsl:attribute>
															<xsl:choose>
																<xsl:when test="function-available('xdFormatting:formatString')">
																	<xsl:value-of select="xdFormatting:formatString(dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime,&quot;datetime&quot;,&quot;dateFormat:none;&quot;)"/>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStartDateandTime"/>
																</xsl:otherwise>
												...
												<tr class="xdTableOffsetRow">
													<td class="xdTableOffsetCellLabel" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 22px; PADDING-RIGHT: 5px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<h4>
															<span class="xdlabel">Initial Visit Stop Date and Time</span>
														</h4>
													</td>
													<td class="xdTableOffsetCellComponent" style="PADDING-BOTTOM: 4px; PADDING-LEFT: 5px; PADDING-RIGHT: 22px; VERTICAL-ALIGN: top; PADDING-TOP: 4px">
														<div style="WIDTH: 223px" class="xdDTPicker" title="" noWrap="1" xd:CtrlId="CTRL17" xd:xctname="DTPicker"><span hideFocus="1" class="xdDTText xdBehavior_FormattingNoBUI" contentEditable="true" xd:xctname="DTPicker_DTText" tabIndex="0" xd:disableEditing="no" xd:innerCtrl="_DTText" xd:boundProp="xd:num" xd:datafmt="&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime">
																<xsl:attribute name="xd:num">
																	<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime"/>
																</xsl:attribute>
																<xsl:choose>
																	<xsl:when test="function-available('xdFormatting:formatString')">
																		<xsl:value-of select="xdFormatting:formatString(dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime,&quot;datetime&quot;,&quot;dateFormat:Short Date;timeFormat:none;&quot;)"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime"/>
																	</xsl:otherwise>
														...
														</div><span hideFocus="1" class="xdTextBox xdBehavior_Formatting" title="" contentEditable="true" xd:CtrlId="CTRL18" xd:xctname="PlainText" tabIndex="0" xd:disableEditing="no" xd:boundProp="xd:num" xd:datafmt="&quot;datetime&quot;,&quot;dateFormat:none;&quot;" xd:binding="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime" style="WIDTH: 223px">
															<xsl:attribute name="xd:num">
																<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime"/>
															</xsl:attribute>
															<xsl:choose>
																<xsl:when test="function-available('xdFormatting:formatString')">
																	<xsl:value-of select="xdFormatting:formatString(dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime,&quot;datetime&quot;,&quot;dateFormat:none;&quot;)"/>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="dfs:dataFields/d:SharePointListItem_RW/d:InitialVisitStopDateandTime"/>
																</xsl:otherwise>
												...
												<tr class="xdTableOffsetRow">
													<td colSpan="2" class="xdTableOffsetCellLabel" style="BORDER-BOTTOM: #dbe5f1 1pt; PADDING-BOTTOM: 4px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px; PADDING-TOP: 8px">
														<div align="left"><input style="WIDTH: auto" class="langFont" title="" value="Start" type="button" xd:CtrlId="CTRL20" xd:xctname="Button" tabIndex="0"/>  <input style="WIDTH: auto" class="langFont" title="" value="Cancel" type="button" xd:CtrlId="CTRL25" xd:xctname="Button" tabIndex="0"/>  </div>
													</td>
												</tr>
											</tbody>
										</table>
