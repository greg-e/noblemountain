...
<xsl:stylesheet version="1.0" xmlns:pc="http://schemas.microsoft.com/office/infopath/2007/PartnerControls" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:q="http://schemas.microsoft.com/office/infopath/2009/WSSList/queryFields" xmlns:my="http://schemas.microsoft.com/office/infopath/2003/myXSD/2012-04-12T18:16:47" xmlns:d="http://schemas.microsoft.com/office/infopath/2009/WSSList/dataFields" xmlns:ma="http://schemas.microsoft.com/office/2009/metadata/properties/metaAttributes" xmlns:dfs="http://schemas.microsoft.com/office/infopath/2003/dataFormSolution" xmlns:dms="http://schemas.microsoft.com/office/2009/documentManagement/types" xmlns:xd="http://schemas.microsoft.com/office/infopath/2003" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:msxsl="urn:schemas-microsoft-com:xslt" xmlns:x="urn:schemas-microsoft-com:office:excel" xmlns:xdExtension="http://schemas.microsoft.com/office/infopath/2003/xslt/extension" xmlns:xdXDocument="http://schemas.microsoft.com/office/infopath/2003/xslt/xDocument" xmlns:xdSolution="http://schemas.microsoft.com/office/infopath/2003/xslt/solution" xmlns:xdFormatting="http://schemas.microsoft.com/office/infopath/2003/xslt/formatting" xmlns:xdImage="http://schemas.microsoft.com/office/infopath/2003/xslt/xImage" xmlns:xdUtil="http://schemas.microsoft.com/office/infopath/2003/xslt/Util" xmlns:xdMath="http://schemas.microsoft.com/office/infopath/2003/xslt/Math" xmlns:xdDate="http://schemas.microsoft.com/office/infopath/2003/xslt/Date" xmlns:sig="http://www.w3.org/2000/09/xmldsig#" xmlns:xdSignatureProperties="http://schemas.microsoft.com/office/infopath/2003/SignatureProperties" xmlns:ipApp="http://schemas.microsoft.com/office/infopath/2006/XPathExtension/ipApp" xmlns:xdEnvironment="http://schemas.microsoft.com/office/infopath/2006/xslt/environment" xmlns:xdUser="http://schemas.microsoft.com/office/infopath/2006/xslt/User" xmlns:xdServerInfo="http://schemas.microsoft.com/office/infopath/2009/xslt/ServerInfo">
...
BODY {
	COLOR: black
			...
			<body>
				...
				<div align="center">
					<table style="BORDER-BOTTOM-STYLE: none; BORDER-LEFT-STYLE: none; WIDTH: 430px; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; BORDER-TOP-STYLE: none; TABLE-LAYOUT: fixed; BORDER-RIGHT-STYLE: none" class="xdFormLayout">
						<colgroup>
						...
						<tbody>
							<tr class="xdTableContentRow">
								<td vAlign="top" class="xdTableContentCell" style="BORDER-BOTTOM: #bfbfbf 1pt; BORDER-LEFT: #bfbfbf 1pt; BORDER-TOP: #000000 1pt; BORDER-RIGHT: #bfbfbf 1pt">
									<div> </div>
									<div>
										<font size="3" face="Lucida Console">Active Contracts</font>
									</div>
									<div>
										<table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 414px; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; TABLE-LAYOUT: fixed; BORDER-TOP: medium none; BORDER-RIGHT: medium none" class="xdLayout" border="1" borderColor="buttontext">
											<colgroup>
											...
											<tbody vAlign="top">
												<tr>
													<td>
														<div align="center">
															<font face="Segoe UI">Count</font>
														</div>
													</td>
													<td>
														<div align="center">
															<font face="Segoe UI">Total Price</font>
														</div>
													</td>
													<td>
														<div align="center">
															<font face="Segoe UI"> <font size="2">Total Cost</font>
															</font>
														</div>
													</td>
													<td>
														<div align="center">
															<font face="Segoe UI">Average Profit</font>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div><span hideFocus="1" class="xdTextBox xdBehavior_Formatting" title="" tabIndex="-1" xd:disableEditing="yes" xd:datafmt="&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;" xd:boundProp="xd:num" xd:xctname="PlainText" xd:CtrlId="CTRL16" xd:binding="my:ActiveContracts/my:CountActiveContracts" style="TEXT-ALIGN: center; WIDTH: 100%; FONT-FAMILY: Segoe UI; WHITE-SPACE: nowrap; FONT-WEIGHT: bold">
																<xsl:attribute name="xd:num">
																	<xsl:value-of select="my:ActiveContracts/my:CountActiveContracts"/>
																</xsl:attribute>
																<xsl:choose>
																	<xsl:when test="function-available('xdFormatting:formatString')">
																		<xsl:value-of select="xdFormatting:formatString(my:ActiveContracts/my:CountActiveContracts,&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;)"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="my:ActiveContracts/my:CountActiveContracts"/>
																	</xsl:otherwise>
													...
													<td>
														<div><span hideFocus="1" class="xdTextBox xdBehavior_Formatting" title="" tabIndex="-1" xd:disableEditing="yes" xd:datafmt="&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;" xd:boundProp="xd:num" xd:xctname="PlainText" xd:CtrlId="CTRL1" xd:binding="my:ActiveContracts/my:SumPriceActiveContract" style="TEXT-ALIGN: center; WIDTH: 100%; FONT-FAMILY: Segoe UI; WHITE-SPACE: nowrap; FONT-WEIGHT: bold">
																<xsl:attribute name="xd:num">
																	<xsl:value-of select="my:ActiveContracts/my:SumPriceActiveContract"/>
																</xsl:attribute>
																<xsl:choose>
																	<xsl:when test="function-available('xdFormatting:formatString')">
																		<xsl:value-of select="xdFormatting:formatString(my:ActiveContracts/my:SumPriceActiveContract,&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;)"/>
																	</xsl:when>
																	<xsl:otherwise>
																		<xsl:value-of select="my:ActiveContracts/my:SumPriceActiveContract"/>
																	</xsl:otherwise>
									...
									<div> </div>
									<div>
										<font face="Segoe UI">Contracts up for Renewal within next 90 days</font>
									</div>
									<div> </div>
								</td>
							</tr>
				...
				<div align="center"> </div>
				<div align="center">
					<table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 429px; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; TABLE-LAYOUT: fixed; BORDER-TOP: medium none; BORDER-RIGHT: medium none" class="xdLayout" border="1" borderColor="buttontext">
						<colgroup>
						...
						<tbody vAlign="top">
							<tr>
								<td style="BACKGROUND-COLOR: #ffffff">
									<div>
										<font size="3" face="Lucida Console">Pending Contracts</font>
									</div>
									<div>
										<table style="BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 233px; BORDER-COLLAPSE: collapse; WORD-WRAP: break-word; TABLE-LAYOUT: fixed; BORDER-TOP: medium none; BORDER-RIGHT: medium none" class="xdLayout" border="1" borderColor="buttontext">
											<colgroup>
												<col style="WIDTH: 100px"></col>
											...
											<tbody vAlign="top">
												<tr>
													<td>
														<div align="center">
															<font size="2" face="Segoe UI">Count</font>
														</div>
													</td>
													<td>
														<div align="center">
															<font size="2" face="Segoe UI">Price</font>
														</div>
													</td>
												</tr>
												<tr>
													<td>
														<div>
															<font size="2" face="Calibri">
																<span class="xdlabel"><span hideFocus="1" class="xdTextBox xdBehavior_Formatting" title="" tabIndex="-1" xd:disableEditing="yes" xd:datafmt="&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;" xd:boundProp="xd:num" xd:xctname="PlainText" xd:CtrlId="CTRL18" xd:binding="my:PendingContracts/my:CountPendingContracts" style="TEXT-ALIGN: center; WIDTH: 100%; FONT-FAMILY: Segoe UI; WHITE-SPACE: nowrap; FONT-WEIGHT: bold">
																		<xsl:attribute name="xd:num">
																			<xsl:value-of select="my:PendingContracts/my:CountPendingContracts"/>
																		</xsl:attribute>
																		<xsl:choose>
																			<xsl:when test="function-available('xdFormatting:formatString')">
																				<xsl:value-of select="xdFormatting:formatString(my:PendingContracts/my:CountPendingContracts,&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;)"/>
																			</xsl:when>
																			<xsl:otherwise>
																				<xsl:value-of select="my:PendingContracts/my:CountPendingContracts"/>
																			</xsl:otherwise>
													...
													<td>
														<div style="FONT-WEIGHT: normal">
															<font face="Calibri"><span hideFocus="1" class="xdTextBox xdBehavior_Formatting" title="" tabIndex="-1" xd:disableEditing="yes" xd:datafmt="&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;" xd:boundProp="xd:num" xd:xctname="PlainText" xd:CtrlId="CTRL17" xd:binding="my:PendingContracts/my:SumPricePendingContracts" style="TEXT-ALIGN: center; WIDTH: 100%; FONT-FAMILY: Segoe UI; WHITE-SPACE: nowrap; FONT-WEIGHT: bold">
																	<xsl:attribute name="xd:num">
																		<xsl:value-of select="my:PendingContracts/my:SumPricePendingContracts"/>
																	</xsl:attribute>
																	<xsl:choose>
																		<xsl:when test="function-available('xdFormatting:formatString')">
																			<xsl:value-of select="xdFormatting:formatString(my:PendingContracts/my:SumPricePendingContracts,&quot;number&quot;,&quot;numDigits:0;negativeOrder:1;&quot;)"/>
																		</xsl:when>
																		<xsl:otherwise>
																			<xsl:value-of select="my:PendingContracts/my:SumPricePendingContracts"/>
																		</xsl:otherwise>
									...
									<div> </div>
									<div>
										<font face="Segoe UI">Pending Contract Aging</font>
									</div>
								</td>
							</tr>
						</tbody>
